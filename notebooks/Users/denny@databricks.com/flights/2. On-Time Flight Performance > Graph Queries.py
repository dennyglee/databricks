# Databricks notebook source exported at Mon, 28 Mar 2016 16:01:12 UTC
# MAGIC %md # On-Time Flight Performance using Spark GraphFrames
# MAGIC ## Graph Queries
# MAGIC This notebook provides GraphFrames queries of the On-Time Flight Performance and Departure Delays data using Apache Spark GraphFrames.  
# MAGIC 
