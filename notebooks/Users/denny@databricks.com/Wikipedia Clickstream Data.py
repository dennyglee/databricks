# Databricks notebook source exported at Sat, 20 Feb 2016 01:03:56 UTC
...
# MAGIC %md 
# MAGIC [<img src="https://databricks.com/wp-content/uploads/2016/02/Spark-Summit-East-2016-Demo-thumbnail.jpg?noresize"/>](https://vimeo.com/155716963)
# MAGIC 
# MAGIC This is the notebook used by Michael Armbrust (@michaelarmbrust) during his demo during Spark Summit East 2016.  The data analysis workflow was developed with [Databricks Community Edition](https://databricks.com/blog/2016/02/17/introducing-databricks-community-edition-apache-spark-for-all.html), a free version of Databricks designed for learning [Apache Spark](https://spark.apache.org/).
# MAGIC 
...
# MAGIC     WHERE 
# MAGIC       curr_title IN ('Donald_Trump') AND
